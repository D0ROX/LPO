...
public class UsaSomaArea {
    ...
    public static void main(String[] args) {
        ...
        Circunferencia circ[] = {
            new Circunferencia(3.0),
            new Circunferencia(2.0)
        };
        ...
        System.out.println("Area dos quadrados = " + soma.calculaArea(quad));
        System.out.println("Area das circunferencias = " + soma.calculaArea(circ));
        System.out.println("Soma de todas as areas = " + soma.calculaArea(superf));
    }
}
